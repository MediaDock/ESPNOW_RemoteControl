...
void mapAndWriteValues()
{
  ...
  valUpForce1 = receiverData.UpForce1;
  valDownForce2 = receiverData.DownForce2;
  valLeftForce3 = receiverData.LeftForce3;
  //valForwardForce0 = map(receiverData.ForwardForce0, 0, 255, 0, 180);
  //Serial.print("valForwardForce0Mapped: ");
  Serial.print("ForwardForce0: ");
  Serial.println(valForwardForce0);
  Serial.print("UpForce1: ");
  Serial.println(valUpForce1);
  Serial.print("DownForce2: ");
  Serial.println(valDownForce2);
  Serial.print("LeftForce3: ");
  Serial.println(valLeftForce3);
