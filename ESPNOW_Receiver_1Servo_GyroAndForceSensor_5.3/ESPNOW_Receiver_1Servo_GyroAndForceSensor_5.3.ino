...
// Servo Index Down
  ...
  if ( ( servoA1 != -1) && ( servoA2 != -1) && ( maxSensorIndex == 4 ) && ( UpDownNeutralIndex == 0 ) ) {
    ESP32_ISR_Servos.setPosition(servoA1, 145);
    delay(50);
    ESP32_ISR_Servos.setPosition(servoA2, 45);
    delay(50);    
...
// Servo Index Up
    ...
    ESP32_ISR_Servos.setPosition(servoA1, 65); // old val 45
    delay(50);     
    ESP32_ISR_Servos.setPosition(servoA2, 145); // old val 135
    delay(50);  
...
// Servo Index Neutral
    ...
    ESP32_ISR_Servos.setPosition(servoA1, 85); //old val 90
    delay(50);
    ESP32_ISR_Servos.setPosition(servoA2, 95); //old val 90
    delay(50);
...
// Servo Index Right
  ...
  if ( ( servoA1 != -1) && ( servoA2 != -1) && ( maxSensorIndex == 2 ) ) {
    ESP32_ISR_Servos.setPosition(servoA1, 5); //old val 135
    delay(50);
    ESP32_ISR_Servos.setPosition(servoA2, 85); //old val 90
    delay(50);    
    Serial.println("Servo Down");
  }
...
// Servo Index Left
    ...
    ESP32_ISR_Servos.setPosition(servoA1, 85); //old val 90
    delay(50);     
    ESP32_ISR_Servos.setPosition(servoA2, 165); // 135
    delay(50);  
    Serial.println("Servo Up");      
  }
